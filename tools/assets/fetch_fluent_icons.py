...
使い方:
  python -m tools.assets.fetch_fluent_icons          # ICONS 全部
  python -m tools.assets.fetch_fluent_icons server database   # 指定分のみ
  python -m tools.assets.fetch_fluent_icons --list   # 利用可能な出力名を一覧表示
...
OUT_DIR = Path(__file__).resolve().parents[2] / "slidegen" / "assets" / "icons" / "fluent"
