...
from slidegen.sample_content_guard import sample_fingerprints
from tools.gallery.build_sample_fingerprints import build
...
def main():
    assert sample_fingerprints() == build(), (
        "python -m tools.gallery.build_sample_fingerprints で混入検出辞書を更新してください。")
