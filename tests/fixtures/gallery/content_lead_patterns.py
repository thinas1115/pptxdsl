...
LEADS = {
    "section_divider": "章の対象範囲と、本文で確認する判断点を示します。",
    ...
    "image_compare": "変更前後のスクリーンショットを並べ、差分を判断に必要な一文だけ添えて示します。",
    ...
    "aws_vpc_layout": "VPC、AZ、Subnetの境界と、その中を通る通信経路を同じ図で確認します。",
    ...
    "config_lab": "設定例と確認観点を並べ、投入後に見るべき状態まで整理します。",
    "knowledge_check": "設問と選択肢を同じ構造で示し、理解した理由まで確認します。",
    "references": "確認に使用した情報源を実URLとともに示し、原典へ移動できるようにします。",
}
