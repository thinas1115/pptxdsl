...
PATTERN_DECK = {
    ...
    "slides": [
        ...
        },
        {
            "type": "cards",
            "kicker": "経営判断",
            "title": "6つの判断材料を同じ粒度で比較する",
            "lead": "各項目を同格に並べ、採用条件と実行上の論点を確認する。",
            "cards": [
                {
                    "heading": "期待効果",
                    "body": "作成とレビューの手戻りを減らし、提出品質を揃える。",
                },
                {
                    "heading": "対象業務",
                    "body": "頻度が高く構成の共通性が高い資料から導入する。",
                },
                {
                    "heading": "実現性",
                    "body": "既存フローを活用し、部門ごとに順次導入できる。",
                },
                {
                    "heading": "導入負荷",
                    "body": "初期教育と運用窓口の準備を展開計画へ含める。",
                },
                {
                    "heading": "主要リスク",
                    "body": "例外資料と固有要件は標準化の対象から切り分ける。",
                },
                {
                    "heading": "判断基準",
                    "body": "品質、作成時間、運用負荷を測定して展開可否を決める。",
                },
            ],
        },
        {
